...
function PasswordPage({ onSuccess }: any) {
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <button type="submit" className="text-white text-base font-semibold leading-normal w-[380px] h-12 px-6 py-3 bg-zinc-800 rounded-lg shadow justify-center items-center gap-2 inline-flex hover:opacity-80 transition-all duration-300 cursor-pointer" onClick={handleSubmit}>
                                Sign in
                            </button>
                        </form>
                    </div>
